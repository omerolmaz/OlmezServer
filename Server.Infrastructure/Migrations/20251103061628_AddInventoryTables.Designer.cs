...
namespace Server.Infrastructure.Migrations
{
    ...
    [Migration("20251103061628_AddInventoryTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Domain.Entities.DeviceInventory", b =>
                {
                    b.Property<Guid>("DeviceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("BiosReleaseDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("CurrentResolution")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("DiskCount")
                        .HasColumnType("int");

                    b.Property<string>("DiskDrives")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OsProductKey")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PrimaryIpAddress")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("ProcessorLogicalProcessors")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Server.Domain.Entities.InstalledPatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DeviceId", "HotFixId")
                        .IsUnique();

                    b.ToTable("InstalledPatches");
                });

            modelBuilder.Entity("Server.Domain.Entities.InstalledSoftware", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DeviceId", "RegistryPath")
                        .IsUnique()
                        .HasFilter("[RegistryPath] IS NOT NULL");
